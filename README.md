...
Some of the documentation in this repo (elaborating on text in this README, mainly) was drafted with Claude and reviewed by us before being merged - no code, video or 3D models were AI-generated. Commits with AI-drafted content are marked with a `Co-Authored-By: Claude` trailer if you want to see which ones.
